...
// This script will accept being run from the web with two query string variables:
   ...
   */
	...
	echo $namephone[$i] . "<br>";
		...
		$query = "insert into qmigo_guests (firstname, lastname, guest_phone, member_id, offer_id) values ('" . $firstnamelastname[0] . "', '" . $firstnamelastname[1] . "','" . $currentnamephone[1] ."', '" . $memberIdValue ."','". $offerIdValue ."')";
